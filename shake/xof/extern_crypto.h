...
#ifndef _EXTERN_CRYPTO_H
#define _EXTERN_CRYPTO_H

//Dependencies
#include "extern_cpu_endian.h"
...
typedef int (*HashAlgoCompute)(const void *data, int length, uint8_t *digest);
...
typedef int (*CipherAlgoInit)(void *context, const uint8_t *key, int keyLen);
typedef void (*CipherAlgoEncryptStream)(void *context, const uint8_t *input, uint8_t *output, int length);
typedef void (*CipherAlgoDecryptStream)(void *context, const uint8_t *input, uint8_t *output, int length);
...
typedef int (*PrngAlgoSeed)(void *context, const uint8_t *input, int length);
typedef int (*PrngAlgoAddEntropy)(void *context, uint_t source, const uint8_t *input, int length, int entropy);
typedef int (*PrngAlgoRead)(void *context, uint8_t *output, int length);
